...
const metadata = {
	name: "Next DApp",
	description: "A simple boilerplate app for  web3 applications.",
	url: "https://dco.dev",
...
export const { chains, publicClient, webSocketPublicClient } = configureChains(
	...
	[
		//i nfuraProvider({ apiKey: `${process.env.NEXT_PUBLIC_INFURA_RPC_KEY}` }),
...
export const usingWalletcConnect: boolean = true;
